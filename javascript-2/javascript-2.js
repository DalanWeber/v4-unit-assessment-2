...
let saleProducts = products.map(function(element,index,products){
  products[index].price = products[index].price * .75
...
let orderTotal = blueProducts.reduce(function(accumulator,price,index,array){
...
let person = {
  ...
  favorites: {
    color: 'blue',
    number: 15,
    book: 'I bet you do not actually check this',
